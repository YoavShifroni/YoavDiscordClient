...
namespace YoavDiscordClient
{
    public class ChatMessagePanel : Panel
    {
        ...
        // Add UserId property to store and access the user ID
        public int UserId { get; private set; }

        public ChatMessagePanel(int userId, string username, string message, Image profileImage, DateTime dateTime)
        {
            // Store the user ID
            this.UserId = userId;
            ...
            this._profilePictureBox.Tag = $"UserImage_{userId}";
